...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1351.832805; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1351.832805; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2281.217858; // x position of the perpendicular encoder (in tick units)
    }
